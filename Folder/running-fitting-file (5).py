...
# for j in range(J):
#     for k in range(K):
#         a_hat[j,k], sigma_err[j,k], Delta_BIC[j,k] = big_func(N, S, times, theta, alpha0, delta0, P_orb_array[k])
...
# np.savez('sunnyvale_data.npz', initial, P_orb_array, a_hat, sigma_err, Delta_BIC,det_percent)